...
<<<<<<< HEAD
    <UnifiedLayout isHomePage={true}>
      ...
      <motion.section
        ...
        className="relative z-10 pt-64 pb-12 px-2 sm:px-4 lg:px-6 xl:px-8 2xl:px-12"
      >
=======
    <>
      {/* Hero Section */}
      <div className="relative z-10 pt-48 pb-12 px-2 sm:px-4 lg:px-6 xl:px-8 2xl:px-12">
