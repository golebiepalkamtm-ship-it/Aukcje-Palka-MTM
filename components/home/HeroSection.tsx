      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mb-6 mt-2">
          <motion.h1
            ...
            className="page-title font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white leading-tight"
          >
            Pałka MTM
            <span className="page-title block text-white/90 mt-4 text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
              Mistrzowie Sprintu
            </span>
          </motion.h1>
          <motion.p
