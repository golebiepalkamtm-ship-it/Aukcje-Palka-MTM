...
async function createSfminoAdminAccount() {
  const email = 'sfmino@palka-mtm.pl';
  const password = 'SfminoAdmin2024!@#'; // Secure password for sfmino admin account
  const displayName = 'Administrator Sfmino';
